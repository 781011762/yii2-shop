...
<div class="header w1210 bc mt15">
    ...
    <div class="logo w1210">
        ...
        <div class="search fl">
            <div class="search_form">
                ...
                <form action="<?=\yii\helpers\Url::to(['index/from-search'])?>" name="serarch" method="get" class="fl">
    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd"><?=\backend\models\GoodsCategory::getGoodsCategories()?></div>
...
<script>
    //ajax获取用户登录状态
    $.getJSON("<?=\yii\helpers\Url::to(['index/user-info'])?>",function(json){
        if(json.isLogin){
            $("#user-info").html("欢迎"+json.name+"&emsp;<a href=\"\">注销登录</a>");
        }
    });
</script>
