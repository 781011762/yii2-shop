...
<body>
			...
			<div class="summary">
				...
				<div class="preview fl">
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
                                <?php
                                foreach ($model->goodsGallery as $gall):?>
								<li class="cur">
									<a id="zoomT" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$gall->path?>',largeimage: '<?=$gall->path?>'}"><img src="<?=$gall->path?>" style="width: 500px"></a>
								</li>
                                <?php endforeach;?>
							</ul>
						</div>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有<ins id="view_time"></ins>点击量)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
    ...
    <script type="text/javascript">
        $().ready(function () {
            $("#zoomT").addClass("zoomThumbActive");
            $.get("<?=\yii\helpers\Url::to(['index/view-times'])?>",{goods_id:<?=$model->id?>},function (data) {
                $("#view_time").text(data);
            })
        });
