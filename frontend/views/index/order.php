                    ...
                    <?php foreach ($models as $model):
						...
						<tr>
							...
							<td>
                                <a href="">
                                    <?php for ($i=0;$i<3;$i++):
                                        if (isset($model->orderGoods[$i])){
                                        ?>
                                    <img src="<?=$model->orderGoods[$i]->logo?>" alt="" />
                                    <?php }endfor;?>
                                </a>
                            </td>
							<td><?=$model->name?></td>
							...
							<td><a href="<?=\yii\helpers\Url::to(['index/pay']).'?order_id='.$model->id?>">微信支付</a> | <a href="">查看</a> | <a href="">删除</a></td>
						</tr>
                    <?php endforeach;
                    ?>
					</tbody> 
